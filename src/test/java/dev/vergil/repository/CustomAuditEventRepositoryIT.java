...
import dev.vergil.MyversionApp;

import dev.vergil.config.Constants;
import dev.vergil.config.audit.AuditEventConverter;
import dev.vergil.domain.PersistentAuditEvent;
...
import static dev.vergil.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = MyversionApp.class)
@Transactional
